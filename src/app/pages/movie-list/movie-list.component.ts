...
export class MovieListComponent {
  movies = [
    ...
    },
    {
      ...
      description: "Mahi, A passionate young traveller, meets Angad, a young, charismatic teacher, in the beautiful hills of Manali. Instant sparks fly between them, leading to a passionate night of intimacy. But the fateful night soon unravels into a series of unforeseen incidents where Mahi finds herself trapped.6",
